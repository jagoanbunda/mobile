    ...
    return (
        <SafeAreaView className="flex-1 bg-background-dark pt-12">
            ...
            >
                ...
                <View className="bg-[#2c2616] p-4 rounded-2xl shadow-sm border border-[#6a5a2f] mb-6 flex-row items-center gap-4">
                    <View className="w-12 h-12 rounded-full bg-primary/20 items-center justify-center border-2 border-primary/30 shrink-0">
                        <MaterialIcons name="child-care" size={24} color="#FAC638" />
                    </View>
                    <View>
                        <Text className="text-lg font-bold text-white leading-tight">Ananda Rizky</Text>
                        <View className="flex-row items-center gap-2 mt-0.5">
                            <Text className="text-xs font-medium text-[#ccbc8e]">2 Tahun 3 Bulan</Text>
                            <View className="w-1 h-1 rounded-full bg-gray-600" />
                            <Text className="text-xs font-medium text-[#ccbc8e]">Laki-laki</Text>
                        </View>
                    </View>
                </View>
                ...
                <View className="mb-8">
                    <View className="flex-row items-center justify-between mb-3">
                        ...
                        <TouchableOpacity className="bg-[#352d18] flex-row items-center gap-1 border-none py-1 pl-3 pr-2 rounded-full shadow-sm">
                            <Text className="text-xs font-bold text-primary">BB / Umur</Text>
                            <MaterialIcons name="arrow-drop-down" size={20} color="#FAC638" />
                        </TouchableOpacity>
                    </View>
                    ...
                    <View className="bg-[#2c2616] rounded-2xl p-4 shadow-sm border border-[#6a5a2f]">
                        ...
                        <View className="flex-row items-center gap-3 justify-center mb-4">
                            <View className="flex-row items-center gap-1">
                                ...
                                <Text className="text-[10px] text-[#ccbc8e]">Normal</Text>
                            </View>
                            <View className="flex-row items-center gap-1">
                                <View className="w-2 h-2 rounded-full bg-yellow-400" />
                                <Text className="text-[10px] text-[#ccbc8e]">Risiko</Text>
                            </View>
                            <View className="flex-row items-center gap-1">
                                <View className="w-3 h-3 rounded-full bg-primary border-2 border-[#2c2616]" />
                                <Text className="text-[10px] text-[#ccbc8e]">Anak</Text>
                            </View>
                        </View>
                        ...
                        <View className="relative w-full aspect-[16/9]">
                            ...
                            <View className="absolute left-0 top-0 bottom-6 w-6 justify-between pr-1">
                                <Text className="text-[9px] text-[#ccbc8e] font-medium text-right">15kg</Text>
                                <Text className="text-[9px] text-[#ccbc8e] font-medium text-right">12kg</Text>
                                <Text className="text-[9px] text-[#ccbc8e] font-medium text-right">9kg</Text>
                                <Text className="text-[9px] text-[#ccbc8e] font-medium text-right">6kg</Text>
                                <Text className="text-[9px] text-[#ccbc8e] font-medium text-right">3kg</Text>
                            </View>
                            ...
                            <View className="absolute left-6 top-0 right-0 bottom-6 border-l border-b border-white/10">
                                <Svg height="100%" width="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
                                    ...
                                    {/* Child Data Line */}
                                    <Path d="M10,85 L30,68 L50,55 L70,30 L90,28" fill="none" stroke="#fac638" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" />

                                    {/* Data Points */}
                                    <Circle cx="10" cy="85" r="4" fill="#fac638" stroke="#2c2616" strokeWidth="2" />
                                    <Circle cx="30" cy="68" r="4" fill="#fac638" stroke="#2c2616" strokeWidth="2" />
                                    <Circle cx="50" cy="55" r="4" fill="#fac638" stroke="#2c2616" strokeWidth="2" />
                                    <Circle cx="70" cy="30" r="4" fill="#fac638" stroke="#2c2616" strokeWidth="2" />
                                    <Circle cx="90" cy="28" r="5" fill="#fac638" stroke="#2c2616" strokeWidth="2" />

                                    {/* Tooltip */}
                                    <G x="55" y="5">
                                        <Rect width="40" height="18" rx="4" fill="#352d18" opacity="0.9" />
                            ...
                            <View className="absolute left-6 right-0 bottom-0 h-6 flex-row justify-between pt-1 px-1">
                                <Text className="text-[9px] text-[#ccbc8e] font-medium">Jul</Text>
                                <Text className="text-[9px] text-[#ccbc8e] font-medium">Aug</Text>
                                <Text className="text-[9px] text-[#ccbc8e] font-medium">Sep</Text>
                                <Text className="text-[9px] text-[#ccbc8e] font-medium">Oct</Text>
                                <Text className="text-[9px] text-[#ccbc8e] font-medium">Nov</Text>
                            </View>
                        </View>
                    </View>
                </View>
                ...
                <View className="flex-row items-center justify-between mb-4 px-1">
                    ...
                    <TouchableOpacity className="flex-row items-center gap-1">
                        <MaterialIcons name="filter-list" size={16} color="#FAC638" />
                ...
                <View className="gap-4">
                    {/* Item 1 */}
                    <View className="bg-[#352d18] rounded-2xl p-5 border border-[#6a5a2f] shadow-sm">
                        <View className="flex-row justify-between items-start mb-4">
                            <View>
                                <View className="flex-row items-center gap-2 mb-1">
                                    <MaterialIcons name="calendar-today" size={16} color="#ccbc8e" />
                                    <Text className="font-bold text-white">12 Oktober 2023</Text>
                                </View>
                                <Text className="text-xs font-medium text-[#ccbc8e] ml-6">Usia: 2 Thn 3 Bln</Text>
                            </View>
                        ...
                        <View className="flex-row">
                            <View className="flex-1 items-center px-1 border-r border-white/10">
                                <Text className="text-[10px] uppercase font-bold text-[#ccbc8e] mb-0.5 tracking-wider">Berat (BB)</Text>
                                <View className="flex-row items-baseline gap-0.5">
                                    <Text className="text-lg font-extrabold text-white">12.5</Text>
                                    <Text className="text-xs font-bold text-[#ccbc8e]">kg</Text>
                                </View>
                                <Text className="text-[10px] font-bold text-green-400 mt-1">Normal</Text>
                            </View>
                            <View className="flex-1 items-center px-1 border-r border-white/10">
                                <Text className="text-[10px] uppercase font-bold text-[#ccbc8e] mb-0.5 tracking-wider">Tinggi (TB)</Text>
                                <View className="flex-row items-baseline gap-0.5">
                                    <Text className="text-lg font-extrabold text-white">88.0</Text>
                                    <Text className="text-xs font-bold text-[#ccbc8e]">cm</Text>
                                </View>
                                <Text className="text-[10px] font-bold text-green-400 mt-1">Normal</Text>
                            </View>
                            <View className="flex-1 items-center px-1">
                                <Text className="text-[10px] uppercase font-bold text-[#ccbc8e] mb-0.5 tracking-wider">Kepala (LK)</Text>
                                <View className="flex-row items-baseline gap-0.5">
                    ...
                    <View className="bg-[#352d18] rounded-2xl p-5 border border-[#6a5a2f] shadow-sm">
                        <View className="flex-row justify-between items-start mb-4">
                            <View>
                                ...
                                <Text className="text-xs font-medium text-[#ccbc8e] ml-6">Usia: 2 Thn 1 Bln</Text>
                            </View>
                ...
                <View className="items-center justify-center pt-4 mb-8">
                    <Text className="text-xs font-medium text-[#ccbc8e]/50">Menampilkan 4 data terakhir</Text>
                </View>
            </ScrollView>
            ...
            <View className="absolute bottom-0 left-0 w-full p-5 bg-background-dark z-10 pt-10">
                ...
                >
                    <MaterialIcons name="add" size={24} color="#231e0f" />
