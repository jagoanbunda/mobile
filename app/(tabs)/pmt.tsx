...
export default function PMTTabScreen() {
    return (
        <SafeAreaView className="flex-1 bg-background-dark pt-12">
            ...
            >
                {/* Status Card */}
                <View className="bg-[#2c2616] rounded-2xl p-5 border border-[#6a5a2f] mb-6">
                    <View className="flex-row items-center gap-3 mb-4">
                        ...
                        <View>
                            ...
                            <Text className="text-sm text-[#ccbc8e]">Hari ke-14 dari 30 hari</Text>
                        </View>
                    </View>
                    ...
                    <View className="mb-2">
                        <View className="flex-row justify-between mb-1">
                            <Text className="text-xs text-[#ccbc8e]">Progress</Text>
                    ...
                    <Text className="text-xs text-[#ccbc8e]">16 hari lagi</Text>
                </View>
                ...
                <View className="flex-row gap-3 mb-6">
                    ...
                    >
                        <MaterialIcons name="add-a-photo" size={24} color="#231e0f" />
                        <Text className="text-background-dark font-bold mt-2">Lapor Hari Ini</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={() => router.push('/pmt/history')}
                        className="flex-1 bg-[#352d18] py-4 rounded-xl items-center justify-center border border-[#6a5a2f]"
                    >
                        <MaterialIcons name="history" size={24} color="#FAC638" />
                ...
                <View className="bg-[#2c2616] rounded-xl p-4 border border-[#6a5a2f] mb-6">
                    <View className="flex-row items-center gap-4">
                        ...
                        <View className="flex-1">
                            ...
                            <Text className="text-sm text-[#ccbc8e]">Disiapkan oleh Kader Posyandu</Text>
                        </View>
                    </View>
                </View>
                ...
                <View className="gap-3">
                    {/* History Item 1 */}
                    <View className="bg-[#2c2616] rounded-xl p-4 border border-[#6a5a2f]">
                        <View className="flex-row justify-between items-start">
                            <View>
                                <Text className="text-xs text-[#ccbc8e] uppercase tracking-wide">Kemarin</Text>
                    ...
                    <View className="bg-[#2c2616] rounded-xl p-4 border border-[#6a5a2f]">
                        <View className="flex-row justify-between items-start">
                            <View>
                                <Text className="text-xs text-[#ccbc8e] uppercase tracking-wide">2 hari lalu</Text>
